...
model = YOLO(r"C:\Users\LENOVO\OneDrive\Documents\Yolov8\best.pt")  # load a custom model

results = model(r"C:\Users\LENOVO\OneDrive\Documents\Yolov8\aleng.jpg")  # predict on an image
